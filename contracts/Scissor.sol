...
contract Scissor is ERC721, Ownable(msg.sender) {
    uint256 public constant MAX_TOKENS = 1;
    uint256 private totalTokensMinted;

    constructor() ERC721("MyScissorCollection", "SCISSORS") {}

    function transferTokenScissor(address _to) external onlyOwner{
